...
function testReorderContract(list) {
    ...
    const test = (srcOrder, destOrder) => {
        ...
        const ordersBeforeSmall = [];
        const ordersAfterBig = [];
        const ordersInBetween = [];
        ...
        const checkOrderUnchanged = (order) => {
